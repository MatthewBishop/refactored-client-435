...
public class SoundSystem {
	...
	public static void clearObjectSounds() {
		for (ObjectSound class40_sub2 = (ObjectSound) SoundSystem.objectSounds.method902(); class40_sub2 != null; class40_sub2 = (ObjectSound) SoundSystem.objectSounds.method909()) {
