...
public class PcmStreamMixer extends PcmStream {
    ...
    public synchronized void skip(int arg0) {
        do {
            ...
            this.anInt2877 += i;
            this.loop0();
            PcmStreamMixerListener class40_sub8 = (PcmStreamMixerListener) this.head.method902();
    ...
    private int fill0(int[] arg0, int arg1, int arg2) {
        ...
        if(this.anInt2875 <= 0) {
            ...
            for(int i = 0; i < 8; i++) {
                ...
                for(PcmStream class40_sub9 = (PcmStream) linkedList.method902(); class40_sub9 != null; class40_sub9 = (PcmStream) linkedList.method909()) {
        ...
        for(int i = 0; i < 8; i++) {
            LinkedList linkedList = this.substreams[i];
            for(PcmStream stream = (PcmStream) linkedList.method902(); stream != null; stream = (PcmStream) linkedList.method909()) {
                stream.active = false;
    ...
    private void loop0() {
        if(this.anInt2877 > 0) {
            for(PcmStreamMixerListener class40_sub8 = (PcmStreamMixerListener) this.head.method902(); class40_sub8 != null; class40_sub8 = (PcmStreamMixerListener) this.head.method909())
