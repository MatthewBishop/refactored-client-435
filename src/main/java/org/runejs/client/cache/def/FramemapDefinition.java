...
public class FramemapDefinition extends Node {
    ...
    public static void spawnGroundItem(int arg1, int arg2) {
        ...
        if(linkedList == null)
            ...
            int i = -99999999;
            Item item = null;
            for(Item item_32_ = (Item) linkedList.method902(); item_32_ != null; item_32_ = (Item) linkedList.method909()) {
            ...
            if(item == null)
                ...
                Item item_34_ = null;
                Item item_35_ = null;
                linkedList.method905(item);
                for(Item item_36_ = (Item) linkedList.method902(); item_36_ != null; item_36_ = (Item) linkedList.method909()) {
