...
public class CacheFileChannel {
    ...
    public void method1033(int arg0, int arg2, byte[] arg3) throws IOException {
        try {
            ...
            if(aLong1593 != -1L && aLong1593 + (long) aByteArray1592.length < (long) arg2 + readIndex) {
                ...
                arg2 -= i;
                _Dup.method278(arg3, arg0, aByteArray1592, (int) (-aLong1593 + readIndex), i);
                readIndex += (long) i;
            ...
            if(arg2 > aByteArray1592.length) {
                ...
                if(l_0_ > -1 && l_0_ < l) {
                    int i = (int) (l - l_0_);
                    _Dup.method278(arg3, (int) ((long) arg0 + l_0_ - readIndex), aByteArray1583, (int) (l_0_ + -aLong1596), i);
                }
                readIndex += (long) arg2;
            } else if(arg2 > 0) {
                if(aLong1593 == -1)
                    aLong1593 = readIndex;
                _Dup.method278(arg3, arg0, aByteArray1592, (int) (readIndex + -aLong1593), arg2);
                readIndex += (long) arg2;
    ...
    public void method1035(byte[] b, int length, int offset) throws IOException {
        try {
            ...
            if(aLong1593 != -1 && aLong1593 <= readIndex && (long) length + readIndex <= (long) anInt1595 + aLong1593) {
                _Dup.method278(aByteArray1592, (int) (readIndex - aLong1593), b, offset, length);
            ...
            if(readIndex >= aLong1596 && (long) anInt1589 + aLong1596 > readIndex) {
                ...
                if(i_3_ > length)
                    i_3_ = length;
                _Dup.method278(aByteArray1583, (int) (-aLong1596 + readIndex), b, offset, i_3_);
                offset += i_3_;
                readIndex += (long) i_3_;
                length -= i_3_;
            }
            if(length <= aByteArray1583.length) {
                if(length > 0) {
                    ...
                    if(i_4_ > anInt1589)
                        i_4_ = anInt1589;
                    _Dup.method278(aByteArray1583, 0, b, offset, i_4_);
                    readIndex += (long) i_4_;
                    offset += i_4_;
                    length -= i_4_;
                }
            ...
            if(aLong1593 != -1L) {
                ...
                if(l_8_ > -1L && l_7_ > l_8_) {
                    ...
                    _Dup.method278(aByteArray1592, (int) (l_8_ - aLong1593), b, (int) (-l + l_8_) + i_2_, i_9_);
                    if(readIndex < l_7_) {
    ...
    public void save() throws IOException {
        if(aLong1593 != -1) {
            ...
            if(l > -1L && l < l_10_) {
                int i = (int) (-l + l_10_);
                _Dup.method278(aByteArray1592, (int) (-aLong1593 + l), aByteArray1583, (int) (l - aLong1596), i);
            }
